  ...
  return (
    <div className="mt-36 flex flex-col items-center bg-contact-gradient-mobile mx-6 lg:mx-0 rounded-3xl" ref={sectionRef}>
        <div className="w-4/5 mb-10  -translate-y-14">
          <img src="/images/form-img.png" alt="brick-img" width={863} height={468} className="flex lg:hidden" />
        </div>
        ...
        <div className="mt-12 flex flex-row justify-around bg-contact-gradient rounded-3xl p-6 lg:px-28 lg:py-20 w-full lg:w-4/5 fade-up-contact  -translate-y-14 lg:translate-y-0 max-w-[1300px]">
            ...
            <div id="business-website" className="bg-transparent placeholder:text-[#f3f3f6] rounded-none text-[#f3f3f6] placeholder:uppercase border-b text-[1rem] lg:text-sm border-[#969696] w-full lg:w-4/5 leading-7 py-2 colorInput relative cursor-pointer">
              ...
              >
                ...
                <span className={`arrow w-3 h-3 ${isOpen ? 'open' : ''}`}>
                  <img src="/images/chevron-down.svg" alt="brick-img" width={16} height={16} />
                </span>
              </div>
              {isOpen && (
          ...
          <div className="relative w-1/2 hidden lg:flex">
            <div className="mt-24 absolute -top-[15%] -right-48">
              <img src="/images/form-img.png" alt="brick-img" width={863} height={468} className="hidden lg:flex" />
            </div>
          </div>
