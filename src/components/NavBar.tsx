...
const NavBar = () => {
  ...
  return (
    ...
    >
      <img src="/images/bilco-logo.svg" alt="bilco logo" width={243} height={38} className={`scale-75 transition-all duration-300 origin-left ${isScrolled ? 'lg:scale-80' : 'lg:scale-100'}`} />
